...
int main(){
  ...
  for (int y = 0; y < velicina; y++)
    for (int x = 0; x < velicina; x++)
    {
      if (x + 3 < velicina)
      {
        int trenutni = matrica[x][y] * matrica[x+1][y] * matrica[x+2][y] * matrica[x+3][y];
        if (max < trenutni)
          max = trenutni;
      }
      if (y + 3 < velicina)
      {
        int trenutni = matrica[x][y] * matrica[x][y+1] * matrica[x][y+2] * matrica[x][y+3];
        if (max < trenutni)
          max = trenutni;
      }
      if (x + 3 < velicina && y + 3 < velicina)
      {
        int trenutni = matrica[x][y] * matrica[x+1][y+1] * matrica[x+2][y+2] * matrica[x+3][y+3];
        if (max < trenutni)
          max = trenutni;
      }
      if (x + 3 < velicina && y >= 3)
